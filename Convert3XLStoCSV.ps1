Function ExcelCSV ($File)
{
    ...
    #This will look in the archive folder and the last file generated and check it againt the current file's Last Write DateTime
...
# Do not change anything below this section#
    ...
    Write-Log "INFO" "and we hav" $logfile
    }
